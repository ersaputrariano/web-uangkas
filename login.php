  ...
  <style>
	* {
  	...
  	body {
	    ...
	    background-image: url(assets/img/img_properties/kampus_um.png);
	}
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: rgba(180,190,196,.6);">
				<h3 class="text-center">APLIKASI PENGELOLAAN UANG KAS TKJ ANGKATAN 2021</h3>
				<form method="post">
				...
				<br><center><p>TKJ 2021</a></p></center>
		...
		<div style="background-color: transparent;" class="container-fluid mt-5">
			<div class="row justify-content-center">
				<div class="col-lg text-center text-white pt-4 pb-2">
					<p>&copy; Copyright 2024. By Ersa Putra Riano</p>
				</div>
			</div>
		</div>
	</footer>
