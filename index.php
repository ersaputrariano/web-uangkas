...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="card shadow">
                <div class="card-body">
                  <h5><i class="text-success fas fa-fw fa-caret-up"></i> <i class="text-success fas fa-fw fa-dollar-sign"></i> Pemasukan Uang Kas</h5>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2024 Ersa Putra Riano</strong>
